...
add_connectivity() {
    # Helper: add_connectivity
    #
    # Parameters
    # ----------
    # $1: side : string
    #   Side of the bar to add the connectivity to, e.g. "left", "right", or "center".
    #
    # Example usage of the function:
    #   add_connectivity left
    ...
    sketchybar --add item datetime $side \
    ...
    sketchybar --add item battery $side \
      --set battery "${battery[@]}" \
    ...
    sketchybar --add slider volume $side \
      --set volume "${volume[@]}" \
